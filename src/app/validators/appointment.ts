...
const appointment_update_object_body = z.object({
  ...
  export type Tappointment_update_body = z.infer<typeof appointment_update_object_body>
  
  export const validator_appointment_update = (body: Tappointment_update_body) => {
