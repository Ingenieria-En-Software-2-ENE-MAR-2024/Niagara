...
import { add_property, formatDateToDb, formatDateToFront, verifyDate } from '../utils/utils'
...
const updateAppointment = async (body: Tappointment_update_body,appointmentId : number) => {
    try {
      ...
      const newAppointmentData = {
        ...
        id_patient: body.id_patient ? body.id_patient : foundAppointment.id_patient,
      }
